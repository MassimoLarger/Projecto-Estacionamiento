    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: Text(
            "¿Estás seguro que deseas modificar la reserva?",
            style: TextStyle(
              fontFamily: 'Lato',
          ...
          actions: <Widget>[
            Row(
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_) => const ModificarReservaExitoWidget()));
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_) => const ModificarReservaErrorWidget()));
                  },
                  style: ElevatedButton.styleFrom(
