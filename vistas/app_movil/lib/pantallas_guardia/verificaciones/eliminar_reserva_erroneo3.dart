...
class EliminarReservaError3Widget extends StatefulWidget {
  const EliminarReservaError3Widget({super.key});

  @override
  EliminarReservaError3WidgetState createState() => EliminarReservaError3WidgetState();
}

class EliminarReservaError3WidgetState extends State<EliminarReservaError3Widget> {
  @override
  void initState() {
    super.initState();
