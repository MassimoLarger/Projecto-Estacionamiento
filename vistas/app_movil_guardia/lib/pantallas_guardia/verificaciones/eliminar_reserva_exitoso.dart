...
class EliminarReservaExitoWidget extends StatefulWidget {
  ...
  @override
  EliminarReservaExitoWidgetState createState() => EliminarReservaExitoWidgetState();
}

class EliminarReservaExitoWidgetState extends State<EliminarReservaExitoWidget> {
  @override
  void initState() {
    super.initState();
