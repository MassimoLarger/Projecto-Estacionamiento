...
class EliminarReservaErrorWidget extends StatefulWidget {
  const EliminarReservaErrorWidget({super.key});

  @override
  EliminarReservaErrorWidgetState createState() => EliminarReservaErrorWidgetState();
}

class EliminarReservaErrorWidgetState extends State<EliminarReservaErrorWidget> {
  @override
  void initState() {
    super.initState();
