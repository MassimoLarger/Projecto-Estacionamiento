...
class ModificarReservaExitoWidget extends StatefulWidget {
  const ModificarReservaExitoWidget({super.key});

  @override
  ModificarReservaExitoWidgetState createState() => ModificarReservaExitoWidgetState();
}

class ModificarReservaExitoWidgetState extends State<ModificarReservaExitoWidget> {
  @override
  void initState() {
    super.initState();
