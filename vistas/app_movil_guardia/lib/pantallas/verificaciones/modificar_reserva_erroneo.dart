...
class ModificarReservaErrorWidget extends StatefulWidget {
  const ModificarReservaErrorWidget({super.key});

  @override
  ModificarReservaErrorWidgetState createState() => ModificarReservaErrorWidgetState();
}

class ModificarReservaErrorWidgetState extends State<ModificarReservaErrorWidget> {
  @override
  void initState() {
    super.initState();
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const Padding(
                ...
                child: Text(
                  'No se ha modificado la reserva.',
                style: TextStyle(
                  color: Color.fromARGB(255, 0, 0, 0),
                  fontSize: 20,
                  fontFamily: 'Lato',
